(() => {
  ...
  const arabic = {
    ...
    'Categories': 'فئات', 'Filter the library': 'تصفية المكتبة', 'Autodesk & BIM': 'Autodesk وBIM', 'Saudi Building Code': 'كود البناء السعودي',
    'Autodesk & BIM Solutions Training': 'تدريب Autodesk وBIM Solutions', 'Open original': 'فتح الملف الأصلي',
